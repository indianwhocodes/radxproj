...
WriteOutput::WriteOutput(std::string progN, Repository *store, RadxVol& readVol, const Params& params, vector<Interp::Field>& interpFields) : _readVol(readVol), _params(params), _interpFields(interpFields)
{
