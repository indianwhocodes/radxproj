...
#include <cstring>
...

  {
    ...
    tt->enum_def.fields = (enum_field_t *)
      ...
      tt->enum_def.fields[1].name = tdrpStrDup("SELF_CON_ZDR_POLYMONIAL_METHOD");
      tt->enum_def.fields[1].val = SELF_CON_ZDR_POLYMONIAL_METHOD;
    ...
    tt->help = tdrpStrDup("SELF_CON_ZDR_POLYNOMIALMETHOD. See equation 4: Qing et al.");
